...
table = CSV.table('input.csv')

# GCP entries to be removed from the CSV report 
gcp_keywords = {
    email: %w(cloudvlab@tudip.com google@tudip.com tudip.com tudip.nl tudip training-support-agents@google.com),
    class: ['Cloud ML Engine','Coursera', 'AWS Educate Starter Account','AWS Educate Starter Account 75 - 2','AWS Educate Starter Account 100','AWS Educate Starter Account 100 - 2','AWS Educate Starter Account 150','AWS Educate Starter Account 150 - 2','AWS Educate Starter Account 30','AWS Educate Starter Account 30 - 2', 'AWS Educate Starter Account 40 - 2', 'AWS Educate Starter Account 50', 'AWS Educate Starter Account 50 - 2', 'AWS Educate Starter Account 75', 'AWS Educate Starter Account 75 - 2','Deployment Manager Quest', 'Apigee Istio Workshop',
...
#AWS Lab details for testing the script execution
=begin
aws_keywords = {
    lab_tags:['spl'],
    class_tags: ['reinvent2017'],
    lab_title:['Automated Video Editing with YOU as the Star!','Serverless Web Apps using Amazon DynamoDB - Part 3','Working with Amazon Redshift','Introduction to Amazon ElastiCache','Troubleshooting Serverless Applications','Serverless Web Apps using Amazon DynamoDB - Part 2','AWS Migration Hub - Track Migrations from a single location','IoT Fleet Management','Automating AWS Services with Scripting and the AWS CLI', 'Introduction to Amazon ElastiCache','Introduction to Amazon API Gateway','Working with Amazon Elastic Block Store (EBS)','Hybrid Storage and Data Migration with AWS Storage Gateway File Gateway','Working with Elastic Load Balancing','Challenge Lab','Analyze Big Data with Hadoop', 'EC2', 'Introduction to AWS Service Catalog', 'Migration Workshop – DMS Lab','Controlling Access to Amazon S3 Resources Using Bucket Policies and IAM Policies','Migrating On-Premises NFS Using AWS DataSync and Amazon File Gateway','Migration Workshop – ADS Lab', 'S3: Multi-region Storage Backup with Cross-Region Replication', 'Visualizing Security Groups with Amazon Elasticsearch Service','Working with Amazon CloudFront for Dynamic Content Acceleration','Programming AWS Security Token Service (STS) with .NET','Introduction to AWS Internet of Things (IoT)','Game Hosting with Amazon GameLift','Programming AWS Lambda for Windows','Centralized Log Processing with Amazon Elasticsearch Service','Live Video Workflow with Captions','AWS Credentials for Automating MultiCloud Network Deployment with Terraform','Datacenter Migration: Assessment', 'Administering Amazon RDS for Microsoft SQL Server', 'Creating a Serverless Video Conversion Watchfolder Workflow for MediaConvert', 'Image Insertion and Input Switching with AWS Elemental MediaLive', 'Image Insertion and Input Switching with AWS Elemental MediaLive', 'Creating Models with Amazon SageMaker', 'IoT Edge Computing: AWS IoT Greengrass']
}
=end

#Loop to delete the GCP labs that are given in the input section
...
#Loop to delete the AWS labs for checking the script
=begin
